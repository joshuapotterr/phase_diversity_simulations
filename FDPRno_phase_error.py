...
'''
focused_wavefront_pupil = Wavefront(telescope_pupil * np.exp(1j*0), #or flatten
                   seal_parameters['wavelength_meter'])
...
try:
    ...
    if oned_grid:
        ...
        print(f'RMS of 1d Reconstruction is {rms_rad} rads, P2V is {p2v_error}')
